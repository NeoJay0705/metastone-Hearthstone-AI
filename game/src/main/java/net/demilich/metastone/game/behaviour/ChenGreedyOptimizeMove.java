...
public class ChenGreedyOptimizeMove extends Behaviour {

	private final static Logger logger = LoggerFactory.getLogger(ChenGreedyOptimizeMove.class);

	private final IGameStateHeuristic heuristic;

	public ChenGreedyOptimizeMove(IGameStateHeuristic heuristic) {
		this.heuristic = heuristic;
	}

	@Override
	public String getName() {
		return "ChenGreedyOptimizeMove";
	}
